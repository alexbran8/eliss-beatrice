...
`const home = {
    label: "Home",
    title: "Eliss Beatrice's Portfolio",
    description: "Portfolio website showcasing my work as an artist",
    headline: <>Artist and visual storyteller</>,
    subline: (
      <>
        I'm Eliss Beatrice, an artist exploring image, emotion, and atmosphere
        <br /> through visual storytelling.
      </>
    ),
};`,
    language: "tsx",

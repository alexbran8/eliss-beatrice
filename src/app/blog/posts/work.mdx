...
You can create, edit and delete projects by adding, modifying or removing `*.mdx` files in the `src/app/paintings/projects` directory.
...
---`,
        language: "tsx",
        label: "src/app/paintings/projects/project-1.mdx"
      }
    ]}
/>
